var express = require('express')
  ...
  //, TweetIt = require('../lib/module-twitter').TweetIt
  , TweetIt = require('../lib/share-social').TweetIt
...
app.get('/auth/twitter/callback', 
  passport.authenticate('twitter',    res.end("Finished updating facebook status");
